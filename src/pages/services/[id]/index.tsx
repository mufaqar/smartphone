...
const ServicesContent = ({ content, mainImage, icon, title, slug }: any) => {
  ...
  return (
    <>
      <SeoMeta
        title={`${title} | Budget Computers's Services `} description={`${title} | We offering a wide range of budget-friendly computers, mobile phones, and related accessories.`} url={`https://budgetrepaircenter.nz/services/${slug}`} />
