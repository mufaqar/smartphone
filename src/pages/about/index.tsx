  ...
  return (
    <>
      ...
      <PageBanner
        ...
        title="About Us" />
      <section className='container mx-auto px-4 bg-white mt-10 mb-10'>
        <motion.div
          ...
          <h2 className='font-bold Raleway text-2xl mb-4'>XBOX Repair:</h2>
          ...
          <h2 className='font-bold Raleway text-2xl mb-4'>Android Tablet Repair </h2>
          <p className='font-normal mb-4'>When it comes to Android tablet repair, there are a few common issues that can arise. One of the most frequent problems is a cracked screen; software malfunctions are common with Android tablets and can cause issues such as freezing or crashing. Another issue many users face is battery problems, such as not charging correctly or draining too quickly. Which accidental drops or hits can cause.</p>
          <h2 className='font-bold Raleway text-2xl mb-4'>Desired:</h2>
          <p className='font-normal mb-4'>And with our free online quote, you can compare our prices to other repair services and see the benefits for yourself. Don't let a broken device keep you from growing and managing your life - let us help you increase your productivity and restore what you've saved.</p>
          <h2 className='font-bold Raleway text-2xl mb-4'>Action:</h2>
          <p className='font-normal mb-4'>Ready to experience the reliable and affordable services of The Only HITECH LAB? Please take action today and drop off or ship us your device for a quote. Our certified technicians will manage your repair carefully and efficiently, ensuring you are back up and running as soon as possible.</p>
          <h2 className='font-bold Raleway text-2xl mb-4'>Conclusion</h2>
          <p className='font-normal mb-4'>In conclusion, Xbox, PS5, iPhones, Samsung,s, OPPO, Huawei, MacBooks, iPads, Android Tablets, Laptops, and Computer repairs can be daunting, especially when you need to become more familiar with the technicalities involved. However, with BUDGET COMPUTERS AND KIWI MOBILES' expert in diagnosis and repair in its HI-TECH LAB, We used the latest tools and machines. We followed the industry protocols to avoid further damage or data loss.  You can have your Device up and running quickly.<br /><br />Trust BUDGET COMPUTERS AND KIWI MOBILES's Xbox Repair Services for all your Device repair needs.<Link href="https://jobform.budgetrepaircenter.nz/" className='text-amber-500 hover:text-blue-300'> Sign Up and Get any device free Quote.</Link> Learn more about our services by visiting our website or contacting us today.</p>
        </motion.div>
      </section>
    </>
  )
