    ...
    <>
      ...
      <section className='container mx-auto px-4 bg-white mt-10 mb-10'>
        <motion.div
          ...
          <h2 className='Raleway text-2xl mb-4'>Ransomware</h2>
          ...
          <h2 className='Raleway text-2xl mb-4'>IPAD Repair:</h2>
          ...
          <div className='lg:flex space-x-10 items-center  mt-10 mb-10'>
            <h2 className='Raleway text-2xl mb-4'>iPhones Repair</h2>
            <Image width={500}
          ...
          <h2 className='Raleway text-2xl mb-4'>Console and Motherboards Repair.</h2>
          ...
          <h2 className='Raleway text-2xl mb-4'>Smartphones Repair:</h2>
          ...
          <h2 className='Raleway text-2xl mb-4'>XBOX Repair:</h2>
          ...
          <h2 className='Raleway text-2xl mb-4'>Android Tablet Repair </h2>
          ...
          <h2 className='Raleway text-2xl mb-4'>Desired:</h2>
          ...
          <h2 className='Raleway text-2xl mb-4'>Action:</h2>
          ...
          <h2 className='Raleway text-2xl mb-4'>Conclusion</h2>
