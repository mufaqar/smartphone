                ...
                <motion.div
                    ...
                    <div className='lg:flex lg:space-x-16 '>
                        <div className='pt-6'>
                            ...
                            <h2 className='Raleway text-md   pb-4 text-[#444444]'>iPad Repair</h2>
                            ...
                            <h2 className='Raleway text-md   pb-4 text-[#444444]'>Battery Issues</h2>
                            ...
                            <h2 className='Raleway text-md  text-[#444444] pb-4'>Water Damage</h2>
                            ...
                            <h2 className='Raleway text-md   pb-4 text-[#444444]'>Conclusion</h2>
