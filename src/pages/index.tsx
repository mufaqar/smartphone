        ...
        <>
            ...
            <section className='py-16 bg-[url("/images/bgg4.avif")] bg-top bg-cover bg-no-repeat bg-fixed min-h-screen h-full bg-blend-overlay bg-black/50 flex flex-col items-center justify-center'>
                <div className='md:max-w-[960px] mx-auto px-4'>
                    ...
                    That's where Affordable iPhone Repair Center, Budget Computers & Kiwi Mobiles Rotorua comes in, providing fast and reliable service since 2014 for all Models of iPhone repair needs, including iPhone screen repair with a 1-year warranty. With expert technicians and quality assurance warranties, Only Budget Repair Centre, HI-TECH LAB, is equipped with the latest tools and machines and expertly qualified Technicians. Don't let a broken device disrupt your life - choose Affordable iPhone Repair in Rotorua, Bay of Plenty, New Zealand 
                    </p>
                </div>
