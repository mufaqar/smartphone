...
export default function Home1({blogsdata, servicesData}:any) {
  ...
  return (
    <>
      <SeoMeta
        title="Budget Computers and Kiwi Mobiles in Rotorua, New Zealand."
        description="Budget Computers  specialize in offering a wide range of budget-friendly computers, mobile phones, and related accessories"
        url="https://budgetrepaircenter.nz/home1"
      />
      <section className='py-16 bg-[url("/images/bgg4.avif")] bg-top bg-cover bg-no-repeat bg-fixed min-h-screen h-full bg-blend-overlay bg-black/50 flex flex-col items-center justify-center'>
        <div className="md:max-w-[960px] mx-auto px-4">
          ...
          <p className="md:text-xl text-base font-normal text-white text-center Raleway my-5">
            That's where Affordable iPhone Repair Center, Budget Computers &
            Kiwi Mobiles Rotorua comes in, providing fast and reliable service
            since 2014 for all Models of iPhone repair needs, including iPhone
            screen repair with a 1-year warranty. With expert technicians and
            quality assurance warranties, Only Budget Repair Centre, HI-TECH
            LAB, is equipped with the latest tools and machines and expertly
            qualified Technicians. Don't let a broken device disrupt your life -
            choose Affordable iPhone Repair in Rotorua, Bay of Plenty, New
            Zealand
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-4 grid-cols-1 gap-5 mt-10">
            {Services?.slice(4, 8)?.map((item: any, idx: number) => {
              return (
                <div
                  key={idx}
                  className="py-[80px] px-5 border border-[#ebebeb] hover:border-white bg-white hover:translate-y-[-10px] hover:shadow-[0_0_25px_rgba(0,0,0,0.1)] transition duration-300 ease-in-out"
                >
                  ...
                  <Link
                    href={item?.link}
                    className="md:text-xl text-xl font-bold text-black text-center Raleway block w-full mt-5"
                  >
                    {item?.title}
                  </Link>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          <h2 className="md:text-4xl text-2xl font-bold Raleway uppercase py-0">
            Why Choose Budget Repair Center Computers & Kiwi Mobiles? Affordable
            iPhone Repair in Rotorua?
          </h2>
          <p className="Raleway uppercase mt-2 text-md font-normal">
            Are you looking for professional and reliable iPhone repair in
            Rotorua? Our expert technicians offer affordable pricing, quick
            turnaround time, and quality parts for long-lasting performance.
            With comprehensive knowledge of various models, we provide
            cost-effective solutions for all your repair needs.
          </p>
      ...
      <section className='py-16 bg-[url("/images/cta-bg.jpg")] bg-top bg-cover bg-no-repeat bg-fixed bg-blend-overlay bg-black/60'>
        <div className="container mx-auto px-4">
          ...
          <Link
            href="#"
            className="text-base font-semibold text-white Raleway border-2 border-white bg-transparent hover:border-yellow-500 hover:bg-yellow-500 rounded py-2 px-[28px] flex justify-center w-fit mx-auto mt-5 transition duration-300 ease-in-out"
          >
            Contact Us
          </Link>
        </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          <p className="Raleway uppercase mt-2 text-md font-normal">
            Our one-stop solution covers a comprehensive range of services for
            various models. Our expertise is in resolving software and hardware
            issues, including specialized repairs for screens, motherboards, and
            water damage. Count on us for convenient and reliable service and
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 grid-cols-1 gap-5 mt-10">
            {blogsdata?.slice(0,3).map((item: any, idx: number) => {
              return (
                <div
                  key={idx}
                  className="border border-[rgba(0,0,0,0.12)] bg-white shadow-[0_2px_5px_0_rgba(0,0,0,0.16)]"
                >
          ...
          <div className="  mt-6">
            ...
            <p className=" font-normal Raleway">
            In conclusion, Budget Center & Computers & Kiwi Mobiles. Affordable Repair in Rotorua offers fast and reliable service for all your smartphone and laptop repair needs <span className="text-red-500">for 11 Years</span>. With expert technicians and a commitment to quality assurance, you can trust that your device is in good hands. We offer comprehensive services to get your device back in working order, from screen to water damage solutions, battery replacements, motherboards and more. The process is convenient and efficient, with convenient scheduling and fast service. And if your device is not an iPhone, we can still help. Don't let a broken device hold you back; contact Affordable iPhone Repair in Rotorua today for all your needs
            </p>  
          </div>
          <div className="border lg:w-[48%] w-full mx-auto mt-6 ">
          <h1 className="text-blue-900">@ BUDGET REPAIR CENTER & COMPUTERS AND KIWI MOBILES</h1>
            <p className='bg-blue-200 font-semibold'>WE DO- All kinds of Electronics, smartphones, Apple Products, Laptops, Desktops, & Peripherals. We specialise in motherboard repair, in-house, and HI-TECH LAB. </p>
          </div>
        </div>
      </section>
    </>
