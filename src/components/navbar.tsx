 ...
 className='flex space-x-2 lg:px-20'>
{
    data.map((item)=>{
        return(
            <Link href={''} className=' lg:animate-bounce text-sm p-2 rounded-full bg-blue-600 text-white hover:bg-orange-500 transition duration-300 ease-in-out hover:opacity-100'>{item.icon}</Link>
